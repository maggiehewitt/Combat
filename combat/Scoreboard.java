 ...
 * 
 *          In refactoring the system, this is the new location where the game
 *          score
 *          will be placed. It is being added because the current location is
 *          the main
 *          class and doesn't really fit there. It causes some coupling in the
 *          system
...
public class Scoreboard extends JPanel {
     ...
     * @throws IllegalArgumentException If the player number is not 1 or 2.
     */
    public void incrementScoreForPlayer(int playerNum) throws IllegalArgumentException {
        if (playerNum < 1 || playerNum > 2) {
            String errorMsg = "The player number must be 1 or 2.";
            throw new IllegalArgumentException(errorMsg);
        }
