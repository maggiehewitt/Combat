 ...
 * 
 *          This class defines a bullet object; it holds the visual
 *          representation of
 ...
 *          Made the amount of travel per tick a class variable so it's easier
 *          to change
 * 
...
public class Bullet extends Sprite {
    ...
    public void moveForward() {
        if (onBoard) {
            ...
            lastLowR = new Point(lastUpL.x + bulletBox.width, lastUpL.y + bulletBox.height);
